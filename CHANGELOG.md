...
- ops: phase 4.9 acceptance tooling — added offline verifier script `backend/scripts/verifyFreshnessSignedExportOffline.js` (`npm run ops:verify-export-offline`) and runbook acceptance sequence to validate key endpoint, public verify, and offline verify end-to-end.
