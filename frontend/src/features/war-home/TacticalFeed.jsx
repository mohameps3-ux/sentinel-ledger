  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        [data-testid="sl-war-live-card"] [class*="min-h-[320px]"] {
          min-height: 268px !important;
          padding: 12px !important;
        }

        [data-testid="sl-war-live-card"] [class*="text-2xl"] {
          font-size: 1.25rem !important;
          line-height: 1.1 !important;
          letter-spacing: -0.035em !important;
        }

        [data-testid="sl-war-live-card"] [class*="text-lg"] {
          font-size: 1rem !important;
          line-height: 1.15 !important;
        }

        [data-testid="sl-war-live-card"] [class*="h-16"][class*="w-16"] {
          width: 50px !important;
          height: 50px !important;
          border-radius: 15px !important;
        }

        [data-testid="sl-war-live-card"] [class*="h-14"][class*="w-14"] {
          width: 46px !important;
          height: 46px !important;
        }

        [data-testid="sl-war-live-card"] [class*="h-10"][class*="w-10"] {
          width: 34px !important;
          height: 34px !important;
        }

        [data-testid="sl-war-live-card"] [class*="pt-4"] {
          padding-top: 0.6rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="pb-3"] {
          padding-bottom: 0.55rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="mt-4"] {
          margin-top: 0.55rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="mt-3"] {
          margin-top: 0.45rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="px-3"][class*="py-2"] {
          padding: 0.45rem 0.55rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="p-3"] {
          padding: 0.55rem !important;
        }

        [data-testid="sl-war-live-card"] [class*="leading-snug"] {
          line-height: 1.25 !important;
        }

        [data-testid="sl-war-live-card"] [class*="tracking-[0.14em]"] {
          letter-spacing: 0.08em !important;
        }

        [data-testid="sl-war-live-card"] [class*="h-9"] {
          height: 34px !important;
        }

        [data-testid="sl-war-live-card"] [class*="pt-4"]:has(a),
        [data-testid="sl-war-live-card"] [class*="pt-4"]:has(button) {
          padding-top: 0.55rem !important;
        }

        [data-testid="sl-war-live-card"] a,
        [data-testid="sl-war-live-card"] button {
