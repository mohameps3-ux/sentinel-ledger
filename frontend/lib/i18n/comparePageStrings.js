...
export const COMPARE_PAGE_STRINGS = {
  ...
  "compare.hero.label": S("Laboratory", { es: "Laboratorio", fr: "Laboratoire" }),
  "compare.hero.h1": S("Token compare lab", { es: "Laboratorio de comparación", fr: "Labo comparatif" }),
  "compare.hero.body": S(
    "Paste two mints and run a full differential — grades, liquidity, holders and deployer risk.",
    {
      es: "Pega dos mints y ejecuta el diferencial completo: notas, liquidez, holders y riesgo del deployer."
    }
  ),
  ...
  "compare.form.submit": S("Compare", { es: "Comparar", fr: "Comparer" }),
