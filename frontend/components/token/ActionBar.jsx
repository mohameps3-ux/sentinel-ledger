  ...
  return (
    <div className="glass-card p-4 flex flex-wrap items-center gap-3 justify-between">
      ...
      <button
        ...
        className="h-11 px-4 rounded-xl bg-[#13171A] border soft-divider text-gray-100 inline-flex items-center gap-2 hover:bg-white/5 transition"
      >
        <Copy size={15} />
        Copy Mint
      </button>
      {typeof onToggleWatchlist === "function" ? (
        <button
          ...
          className={`h-11 px-4 rounded-xl inline-flex items-center gap-2 transition ${
            isWatchlisted
