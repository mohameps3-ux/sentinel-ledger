...
export function SmartWalletDetailPanel({ row, labelFor, titleFor, narrativeLang }) {
  ...
  return (
    <div className="space-y-4 text-left">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 border border-white/10 p-3 bg-white/[0.02]">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          <button
            type="button"
            onClick={copyAddress}
            className="inline-flex items-center gap-1.5 text-[11px] px-2.5 py-1.5 border border-white/15 bg-white/5 text-gray-200 hover:bg-white/10"
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-[11px] px-2.5 py-1.5 border border-emerald-500/30 bg-emerald-500/10 text-emerald-200 hover:bg-emerald-500/20"
          >
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2 text-sm">
          <div className="border border-white/10 p-2 bg-white/[0.02] text-center">
      ...
      {p ? (
        <div className="border border-violet-500/20 bg-violet-500/[0.06] p-3 space-y-2">
